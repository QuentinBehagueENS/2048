...
char* txt[12] = {"0","2","4","8","16","32","64","128","256","512","1024","2048"};

int txt_index[12] = {0, 0, 0, 0, 0, 0, 0, 2, 2, 2, 3, 3};
...
/* Compilation commands :
    - gcc -Wall src\*.c -o bin\2048.exe -I include -L lib -lmingw32 -lSDL2main -lSDL2 && .\bin\2048.exe
